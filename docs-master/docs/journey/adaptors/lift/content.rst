...
|acquia-product:cha|: Content adaptor
=====================================

The |acquia-product:cha| content adaptor allows |acquia-product:aj| to fetch a
content item from |lift product|_ using information gathered as your customer
journey executes. The adaptor uses the APIs exposed by |acquia-product:cha| and
described in the |acquia-product:cha| `Decision API documentation
<http://docs.lift.acquia.com/decision/#>`__.

.. |lift product| replace:: \ |acquia-product:ch| \ 
.. _lift product: https://www.acquia.com/gb/products-services/acquia-lift-content-syndication

Creating the adaptor
--------------------

To use the |acquia-product:cha| content adaptor, complete the following
steps:
...
#. Configure the following settings for the adaptor:
   ...
   -  **content_connector_id** - Identifier for the content connector —
      defaults to *content_hub*
   ...
   For more information about the |acquia-product:cha| content API, see
   the |acquia-product:cha| `Decision
   API <http://docs.lift.acquia.com/decision/#content__contentId__get>`__.
