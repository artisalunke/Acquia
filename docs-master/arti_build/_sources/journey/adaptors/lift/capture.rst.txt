...
|acquia-product:cha|: Capture adaptor
=====================================

The |acquia-product:cha| capture adaptor allows |acquia-product:aj| to
capture journey information as your customer journey executes. The
adaptor uses the APIs provided by |acquia-product:cha| and described in
the |acquia-product:cha| `Decision API
documentation <http://docs.lift.acquia.com/decision/#>`__.

Creating the adaptor
--------------------

To use the |acquia-product:cha| capture adaptor, complete the following
steps:
...
#. Configure the following settings for the adaptor:
   ...
   -  **Adaptor Action** list - Click **Capture**
   -  **site_id** - Identifier for the customer website
   -  **prefetch** - Boolean determining whether to prefetch the
   ...
   For information about the |acquia-product:cha| capture API method,
   see the |acquia-product:cha| `Decision
   API <http://docs.lift.acquia.com/decision/#capture_post>`__.
