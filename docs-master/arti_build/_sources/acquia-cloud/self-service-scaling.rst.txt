...
#. Sign in to the `|acquia-product:ac| user
...
#. In the left menu, click `Stack
   Metrics </acquia-cloud/monitor/stackmetrics%20>`__, and then, in the
...
+-----------------------------------+-----------------------------------+
| **Application Usage**             | Number of applications in use out |
|                                   | of the total number of available  |
|                                   | applications                      |
+-----------------------------------+-----------------------------------+
| **Max File Storage**              | Maximum amount of file storage    |
|                                   | available for this subscription,  |
|                                   | in gigabytes (GB)                 |
+-----------------------------------+-----------------------------------+
| **Max Database Storage**          | Maximum amount of database space  |
|                                   | available, in gigabytes (GB)      |
+-----------------------------------+-----------------------------------+
...
.. |Upgrading your plan| image:: https://cdn4.webdamdb.com/1280_DNHN59GZQA31.png?-62169955200
   :width: 1006px
   :height: 486px
.. |Confirming your resize| image:: https://cdn2.webdamdb.com/1280_QdWczAbatn91.png?-62169955200
   :width: 601px
   :height: 362px
